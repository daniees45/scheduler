 ...
 * 
 * Run this script to verify R2 is configured correctly:
 * php test_r2.php
 */
...
echo "========================================\n";
echo "  R2 Storage Configuration Test\n";
echo "========================================\n\n";

try {
    $r2 = new R2Storage();
    
    echo "✓ R2Storage class loaded successfully\n";
    
    // Check if R2 is enabled
    if (!$r2->isEnabled()) {
        echo "\n⚠️  R2 is DISABLED\n";
        echo "    Set 'enabled' => true in config/r2_config.php\n";
    ...
    $testKey = 'csv/test/r2_test_' . time() . '.txt';
    
    $uploadResult = $r2->uploadContent($testContent, $testKey, [
        'test' => 'true',
    ...
    if ($uploadResult['success']) {
        ...
        $downloadResult = $r2->download($testKey);
        ...
        $listResult = $r2->listFiles('csv/test/', 10);
        ...
        $deleteResult = $r2->delete($testKey);
        ...
        echo "========================================\n\n";
        echo "R2 is configured correctly and ready to use.\n\n";
        ...
        echo "========================================\n";
        echo "1. Check credentials in config/r2_config.php\n";
        echo "2. Verify bucket name matches your R2 bucket\n";
        echo "3. Ensure API token has 'Object Read & Write' permissions\n";
        echo "4. Check endpoint format: https://<account_id>.r2.cloudflarestorage.com\n";
